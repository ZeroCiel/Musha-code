...
--adds action start
	ACTIONFAIL =
	{
		...
		USEKLAUSSACKKEY =
        {
			...
			QUAGMIRE_WRONGKEY = "Musha need to find another key.",
        },
		ACTIVATE = 
		{
		...
		GIVE =
        {
            ...
            MUSHROOMFARM_needSHROOM = "A mushroom would probably be of more use.",
            MUSHROOMFARM_needLOG = "A living log would probably be of more use.",
        ...
        WRAPBUNDLE =
        {
            EMPTY = "Musha need to have something to wrap.",
        },
        PICKUP =
        {
        ...
        REPLATE =
        {
            MISMATCH = "It need another type of dish.", 
	...
	ANNOUNCE_NODANGERSIESTA = "Musha heard something. Musha need to check it out.",
	ANNOUNCE_NONIGHTSIESTA = "It's too cold to rest here!",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "It's really cold be in here.",
	ANNOUNCE_NOHUNGERSIESTA = "Musha is hungry! Musha need food!",
	...
	--ANNOUNCE_HUNGRY = "Musha need meat. Anyone?",
...
--adds 5 start (DESCRIBE)
	--MULTIPLAYER_PORTAL = "This ought to be a scientific impossibility.",
		...
		WX78 = 
		{
			...
			ATTACKER = "Musha thinks Musha need to tweak your primary directive, %s...",
...
--adds 6 end
		...
		MEATRACK =
		{
			...
			DRYINGINRAIN = "It seems like it need an umbrella.",
	...
	--adds 1 end
		...
		TREASURECHEST =
		{
			GENERIC = "Musha need lots of things, so Musha will make lots of boxes.",
        ...
        ANCIENT_ALTAR =
        {
        	...
        	BROKEN = "It is working, but need something else to be at full power.",
        },
        ANCIENT_ALTAR_BROKEN = "It is working, but need something else to be at full power.",
		...
		CAMPFIRE =
		{
			EMBERS = "Musha need to put fuel in the pit.",
		...
		DECIDUOUSTREE =
		{
			BURNING = "Ah! Hot! Hot! Fire! Fire! The tree need water quick!",
		...
		HEATROCK =
		{
			...
			GENERIC = "Musha need to keep it Cooler in summer, and hotter in winter.",
		...
		MARSH_BUSH =
		{
			BURNING = "Fire! Fire! Hey, Musha need water!",
		...
		MAXWELLLOCK = "Hmm, Musha need a key.",
	...
	--adds 2 end	
		...
		SAPLING =
		{
			...
			WITHERED = "It need water. Or poop.",
		...
		SPIDER =
		{
			DEAD = "Musha need more spiders to become stronger.",
		...
		SPIDER_WARRIOR =
		{
			...
			GENERIC = "It can lunge and bite from a distance. Musha need to be careful.",
		...
		TALLBIRDEGG_CRACKED =
		{
			COLD = "The egg need to be warmer!",
		...
		TELEPORTATO_BASE =
		{
			...
			LOCKED = "need something before Musha can use it.",
	...
	--adds 3 start
        ...
        PERDSHRINE =
        {
            ...
            EMPTY = "Musha need to plant something there.",
        ...
        WARGSHRINE = 
        {
            ...
            EMPTY = "Musha need to put a torch in it.",
