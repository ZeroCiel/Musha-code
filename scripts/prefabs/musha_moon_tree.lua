...
inst.yamche = false
	if not inst.components.follower.leader then 
		inst.MiniMapEntity:SetIcon( "musha_moon_tree.tex" )
...
return Prefab("musha_moon_tree", common_fn, assets, prefabs),
  MakePlacer("musha_moon_tree_placer", "leif", "leif_moon_build", "idle")
