...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.MUSHA_MOON_TREE = "He is 'Dall na mu'.\nIt means, The  Moon Tree in an ancient word.\nCommand:(F2)"
...
STRINGS.RECIPE_DESC.MUSHA_MOON_TREE = "Companion Dall\n (Order key:'F2')"
STRINGS.NAMES.MUSHA_MOON_TREE = "Tree of the Moon"
...
STRINGS.MUSHA_LEVEL_INFORMATION = "This item is the MAX level!"
STRINGS.MUSHA_NOTFUEL = "The fuel is running out and more needs to be added."
